...
#pragma GCC diagnostic ignored "-Wreturn-type"
  switch (status) {
    ...
    case CPU_STATUS::HALT_MODE: {
      return "HALT";
    }
    case CPU_STATUS::STOP: {
      return "STOP";
    }
    case CPU_STATUS::PAUSED: {
      return "PAUSED";
    }
  }
}
...
void SharpSM83::m_cycle() {
  ...
  if (timer.ticking_enabled) {
    ...
    u16 div_bits = (timer.div & (1 << offset_table[bus->wram.data[TAC] & 0x3])) >> offset_table[bus->wram.data[TAC] & 0x3];
