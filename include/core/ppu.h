...
class PPU {
  RENDERING_MODE ppu_mode = VBLANK;
...
//  u8 get_ppu_mode() const;
  ...
  u8 w_line_count   = 0;
  u8 w_x_pos_offset = 0;
  u16 get_tile_bg_map_address_base() const;
  u16 get_tile_window_map_address_base() const;
